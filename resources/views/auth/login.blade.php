...
<head>
    ...
    <meta name="description" content="{{ \App\Models\Setting::getByKey('login-description','content') }}"/>

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ \App\Models\Setting::getImage('favicon') }}"/>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                            <img width="30px" src="{{ \App\Models\Setting::getImage('logo') }}" alt="logo">
                  </span>
                            <span
                                class="app-brand-text demo text-body fw-bolder">{{ \App\Models\Setting::getByKey('website-title','title') }}</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to {{ \App\Models\Setting::getByKey('website-title','title') }}! 👋</h4>
